        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@focusdancestudio.com" className="text-neutralGrey text-sm hover:text-white transition-colors">info@focusdancestudio.com</a>
                </div>
              </div>
            ...
            <div className="mt-12">
              ...
              <a href="https://www.instagram.com/focusdance_studio/" target="_blank" rel="noopener noreferrer" className="inline-block p-3 border border-neutralGrey/30 rounded-full hover:bg-deepGreen hover:border-deepGreen transition-colors">
                <Instagram size={20} />
              </a>
            </div>
          </div>
